...
export class MatchComponent implements OnInit {
  ...
  constructor() { 
    ...
    this.matches.push({name:"Test Testerino", description: "I'm an evil beast", imgUrl:"https://images.pexels.com/photos/323503/pexels-photo-323503.jpeg?w=1260&h=750&auto=compress&cs=tinysrgb"});
